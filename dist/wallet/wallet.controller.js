...
let WalletController = class WalletController {
    ...
    async transferToUser(transferDto, req) {
        const userId = req.user.id;
    ...
    async payWithBalance(payWithBalanceDto, req) {
        const userId = req.user.id;
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [wallet_dto_1.TransferDto, Object]),
    __metadata("design:returntype", Promise)
], WalletController.prototype, "transferToUser", null);
__decorate([
    (0, common_1.Post)('pay'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.USER),
    ...
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [wallet_dto_1.PayWithBalanceDto, Object]),
    __metadata("design:returntype", Promise)
